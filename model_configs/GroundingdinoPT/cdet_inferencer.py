...
class DetInferencer(BaseInferencer):
    ...
    def __call__(
        ...
        if Debug_Lin:
                print('tokens_positive: ', tokens_positive) # Debug_Lin
        ...
        if prompt_pth is not None:
            for i in range(len(ori_inputs)):
                ori_inputs[i]['prompt_pth'] = prompt_pth
    ...
    def pred2dict(self,
        ...
        if is_save_pred:
            print(result.keys()) # print keys of the result
